...
function getNextStateIndex(trafficLight) {
  ...
  if (trafficLight.stateIndex == trafficLight.possibleStates.leng - 1) {  // if state.Index == last 
    return 0;                                                             // return state.Index 0
  } else {                                                                // otherwise 
    return trafficLight.stateIndex + 1;                                   // state.Index + 1
  }
}
